...
public class editdetailsmadmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editdetailsmadmin);
        editTextName = findViewById(R.id.editdetailsnamemadmin);
        profileimage = findViewById(R.id.profileImageViewmadmin);
        editTextPhno = findViewById(R.id.editdetailsphnomadmin);
        buttonSave = findViewById(R.id.savechangesmadmin);
        progressBar = findViewById(R.id.progresseditmadmin);
        constraintLayout = findViewById(R.id.constrainteditmadmin);
        circleImageView = findViewById(R.id.profileImageViewmadmin);
        ...
        usersRef = FirebaseDatabase.getInstance().getReference("admins").child(currentUser.getUid());
        ...
        usersRef.child("profileImageUrl").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DataSnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    if (uri != null) {
                        Glide.with(editdetailsmadmin.this)
                                .load(uri)
