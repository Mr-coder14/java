...
public class Orderdetailsallorders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_orderdetailsallorders);

        backbtn = findViewById(R.id.backuser19);
        dbtn=findViewById(R.id.downloadbtnuser19);
        orderinfo=findViewById(R.id.orderinfouser19);
        mAuth=FirebaseAuth.getInstance();
        userid=mAuth.getCurrentUser().getUid();

        recyclerView=findViewById(R.id.recyculerviewuser19);
        progressBar=findViewById(R.id.progressadmin11user9);
        progressBar.setVisibility(View.VISIBLE);
        gt=findViewById(R.id.gtuser19);
        ...
        pdfsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(Orderdetailsallorders.this, "No files", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        orderinfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Orderdetailsallorders.this, Proccessactivityallorders.class);
